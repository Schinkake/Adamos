...
void irq_remap()
{
	port8BitWrite(0x20, 0x11);
	port8BitWrite(0xA0, 0x11);
	port8BitWrite(0x21, 0x20);
	port8BitWrite(0xA1, 0x28);
	port8BitWrite(0x21, 0x04);
	port8BitWrite(0xA1, 0x02);
	port8BitWrite(0x21, 0x01);
	port8BitWrite(0xA1, 0x01);
	port8BitWrite(0x21, 0x0);
	port8BitWrite(0xA1, 0x0);
}
